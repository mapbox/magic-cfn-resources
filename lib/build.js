...
function build(params) {
  ...
  customFunctions[params.CustomFunctionName][params.LogicalName] = {
    Type: cf.join(['Custom::', params.CustomFunctionName, 'Function']),
    Properties: Object.assign({ ServiceToken: cf.getAtt(cf.join([params.CustomFunctionName, 'Function']), 'Arn')}, params.Properties)
  };
